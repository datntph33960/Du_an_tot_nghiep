...
return pdo_query($sql, $order_id);
        ...
        public function insert_orders($user_id, $total, $address, $phone, $note, $shipping_fee) {
            $sql = "INSERT INTO orders(user_id, total, address, phone, note, shipping_fee) VALUES(?,?,?,?,?,?)";
            pdo_execute($sql, $user_id, $total, $address, $phone, $note, $shipping_fee);
        }
