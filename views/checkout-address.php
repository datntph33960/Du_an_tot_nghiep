...
try {    
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["checkout"])) {
        ...
        $arr_size = $_POST["size"]; // Lấy kích thước
        $arr_color = $_POST["color"]; // Lấy màu sắc
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <p style="color: #000000; font-weight:500; font-size: 15px;">Bạn có thể nhập địa chỉ khác, hoặc sử dụng địa chỉ mặc định</p>
                            </div>
                            <div class="col-lg-5">
                                <div class="cart__btn">
                            ...
                            <div class="checkout__order__product">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span class="text-muted">(Kích thước: <?= htmlspecialchars($product_size) ?>, Màu sắc: <?= htmlspecialchars($product_color) ?>)</span> <!-- Hiển thị kích thước và màu sắc -->
                                    </li>
                                    <?php
                                        }
                                    ?>
