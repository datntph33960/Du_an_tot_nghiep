                                        ...
                                        <li>
                                            <?php if (isset($_SESSION['user'])) { ?>
                                                <form action="index.php?url=gio-hang" method="post">
                                                    ...
                                                    <input type="hidden" name="image" value="<?= htmlspecialchars($first_image) ?>">
                                            ...
                                            <?php } else { ?>
                                                <button type="button" onclick="alert('Vui lòng đăng nhập để thực hiện chức năng');" name="add_to_cart" id="toastr-success-top-right" style="border: none; background: none;">
