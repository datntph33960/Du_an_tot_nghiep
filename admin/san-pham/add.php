            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <div class="mb-3">
                    ...
                    ?>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="sizes[]" value="<?= $size ?>" id="size_<?= $size ?>" <?= in_array($size, $selected_sizes) ? 'checked' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    foreach ($available_colors as $color) : 
                        $color_slug = strtolower(preg_replace('/[^a-zA-Z0-9]/', '', $color)); // ID an toàn
                    ?>
                        <div class="form-check form-check-inline">
